...
export interface components {
  schemas: {
    ...
    Media: (components["schemas"]["Photo"] | components["schemas"]["Video"] | components["schemas"]["AnimatedGif"]) & {
      type: string;
    };
    /**
     ...
     */
    MediaId: string;
    Photo: components["schemas"]["CommonMediaFields"] & {
      type?: "photo";
      /** Format: uri */
      url?: string;
      alt_text?: string;
    };
    Video: components["schemas"]["CommonMediaFields"] & {
      type?: "video";
      /** Format: uri */
    ...
    AnimatedGif: components["schemas"]["CommonMediaFields"] & {
      type?: "animated_gif";
      /** Format: uri */
      preview_image_url?: string;
    };
    ...
    GenericProblem: components["schemas"]["ProblemFields"] & {
      type?: "about:blank";
      status: number;
    };
    /** @description A problem that indicates this request is invalid. */
    InvalidRequestProblem: components["schemas"]["ProblemFields"] & {
    ...
    ResourceNotFoundProblem: components["schemas"]["ProblemFields"] & {
    ...
    ResourceUnauthorizedProblem: components["schemas"]["ProblemFields"] & {
    ...
    ResourceUnavailableProblem: components["schemas"]["ProblemFields"] & {
    ...
    FieldUnauthorizedProblem: components["schemas"]["ProblemFields"] & {
    ...
    ClientForbiddenProblem: components["schemas"]["ProblemFields"] & {
    ...
    DisallowedResourceProblem: components["schemas"]["ProblemFields"] & {
    ...
    UnsupportedAuthenticationProblem: components["schemas"]["ProblemFields"] & {
      type?: "https://api.twitter.com/2/problems/unsupported-authentication";
    };
    /** @description A problem that indicates that a usage cap has been exceeded. */
    UsageCapExceededProblem: components["schemas"]["ProblemFields"] & {
    ...
    ConnectionExceptionProblem: components["schemas"]["ProblemFields"] & {
    ...
    ClientDisconnectedProblem: components["schemas"]["ProblemFields"] & {
      type?: "https://api.twitter.com/2/problems/client-disconnected";
    };
    /** @description You have been disconnected for operational reasons. */
    OperationalDisconnectProblem: components["schemas"]["ProblemFields"] & {
    ...
    StreamingTweet:
      | components["schemas"]["SingleTweetLookupResponse"]
      | {
          errors: components["schemas"]["Problem"][];
        };
    /** @description A tweet or error that can be returned by the streaming tweet API */
    ...
    AddOrDeleteRulesResponse: components["schemas"]["AddRulesResponse"] | components["schemas"]["DeleteRulesResponse"];
